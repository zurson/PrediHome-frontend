...
import com.betoniarze.predihome.core.host.RegisterActivity
...
fun LoginView() {
    ...
    ConstraintLayout(
        ...
        val infoTopGuideline = createGuidelineFromTop(0.1f)
        val infoBottomGuideline = createGuidelineFromTop(0.25f)

        HeaderText(modifier = Modifier.constrainAs(infoAppName) {
        ...
        val buttonsTopGuideline = createGuidelineFromTop(0.55f)
        ...
        Column(modifier = Modifier.constrainAs(loginButtonRef) {
            ...
            CustomOutlinedButton(
                onClick = {
                    if (viewModel.validateEmail() && viewModel.validatePassword())
                        viewModel.loginViaEmail(context)
                },
            ...
            Row(modifier = Modifier.weight(1f)) {
                ...
                CustomOutlinedButton(
                    onClick = {
                        viewModel.loginWithGoogle(context, GoogleAuthType.LOGIN)
                    },
                    modifier = Modifier.weight(1f)
                ) {
                    Image(
            ...
            CustomOutlinedButton(
                ...
                Text(
                    text = Strings.LOGIN_SIGNUP_BUTTON_TEXT,
                    color = MaterialTheme.colorScheme.secondary,
                    fontSize = dpToSp(R.dimen.auth_button_text_size)
                )
            }
...
fun HeaderText(modifier: Modifier = Modifier) {
    Text(
        ...
        fontSize = dpToSp(R.dimen.auth_header_text_size),
        color = MaterialTheme.colorScheme.onBackground,
...
fun LoginDescription(modifier: Modifier = Modifier) {
    Text(
        text = Strings.LOGIN_DESCRIPTION,
        maxLines = 2,
        color = MaterialTheme.colorScheme.onBackground,
